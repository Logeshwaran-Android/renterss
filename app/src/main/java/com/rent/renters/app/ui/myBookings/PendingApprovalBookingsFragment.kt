...
class PendingApprovalBookingsFragment : Fragment()  ,MyBookingsAdapter.MyBookingsClickListener{
    ...
    private fun callGetBookings(){
        myBookingsViewModel.callGetPendingHostApprovalBookingList(mPage).observe(viewLifecycleOwner, Observer<MyTripsResponse> {
