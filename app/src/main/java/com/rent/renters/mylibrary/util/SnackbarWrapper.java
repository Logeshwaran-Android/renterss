...
public class SnackbarWrapper
{
    ...
    @NonNull
    public static SnackbarWrapper make(@NonNull Context applicationContext, @NonNull CharSequence text, @NonNull CharSequence message, @Snackbar.Duration int duration)
    {
        mContext = applicationContext;
        return new SnackbarWrapper(applicationContext, text,message, duration);
    }

    private SnackbarWrapper(@NonNull final Context appplicationContext, @NonNull CharSequence text,@NonNull CharSequence message, @Snackbar.Duration int duration)
    {
    ...
    private void onSnackbarContainerAttached(final View rootView, final CoordinatorLayout snackbarContainer)
    {
        ...
        TSnackbar snackbar = TSnackbar.make(snackbarContainer, message, TSnackbar.LENGTH_LONG);
