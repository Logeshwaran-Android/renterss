...
import static com.rent.renters.mylibrary.util.RangeSeekBar.NumberType.*;
...
public class RangeSeekBar<T extends Number> extends AppCompatImageView {
    ...
    public static final int ACTIVE_COLOR = Color.argb(0xFF, 0x00, 0x84, 0x89);
    /**
    ...
    private void init(Context context, AttributeSet attrs) {
        float barHeight;
        int thumbNormal = R.drawable.ic_slider;
        int thumbPressed = R.drawable.ic_slider;
        int thumbDisabled = R.drawable.ic_slider;
