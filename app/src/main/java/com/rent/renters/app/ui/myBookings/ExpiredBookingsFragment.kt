...
class ExpiredBookingsFragment : Fragment() ,MyBookingsAdapter.MyBookingsClickListener{
    ...
    private fun callGetBookings(){
        myBookingsViewModel.callGetExpiredBookingList(mPage).observe(viewLifecycleOwner, Observer<MyTripsResponse> {
