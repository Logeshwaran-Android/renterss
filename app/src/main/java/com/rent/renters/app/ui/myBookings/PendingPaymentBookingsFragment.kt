...
class PendingPaymentBookingsFragment : Fragment(),MyBookingsAdapter.MyBookingsClickListener {
    ...
    private fun callGetBookings(){
        myBookingsViewModel.callGetPendingPaymentBookingList(mPage).observe(viewLifecycleOwner, Observer<MyTripsResponse> {
