...
class UpcomingCheckinBookingsFragment : Fragment() ,MyBookingsAdapter.MyBookingsClickListener  {

    private lateinit var myBoookingsViewModel: MyBookingsViewModel
    ...
    private fun initViewModel() {
        myBoookingsViewModel = ViewModelProvider(this).get(MyBookingsViewModel::class.java)
        myBoookingsViewModel.initMethod(context as Activity)
        callGetBookings()

    }
    private fun callGetBookings(){
        myBoookingsViewModel.callGetUpcomingCheckinBookingList(mPage).observe(viewLifecycleOwner, Observer<MyTripsResponse> {
